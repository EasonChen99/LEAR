...
class Decoder_Edge(nn.Module):
    ...
    def forward(self, tenVggList):
        tenInput, tenVggOne, tenVggTwo, tenVggThr, tenVggFou, tenVggFiv = tenVggList
...
#         return depth_feature_5, event_feature_5, [depth, edge_feature_1,edge_feature_2,edge_feature_3,edge_feature_4,edge_feature_5]
...
#         # edge encoder
#         self.edge_layer1 = nn.Conv2d(input_dim, 64, kernel_size=7, stride=2, padding=3)
#         self.relu2 = nn.ReLU(inplace=True)
#         self.in_planes = 64
#         self.edge_layer2 = self._make_layer(64, stride=1)
#         self.edge_layer3 = self._make_layer(96, stride=2)
#         self.edge_layer4 = self._make_layer(128, stride=2)
#         self.edge_layer5 = nn.Conv2d(128, output_dim, kernel_size=1)

#         self.fusion1_flow = nn.Conv2d(128, 64, kernel_size=1)
#         self.fusion1_edge = nn.Conv2d(128, 64, kernel_size=1)
#         self.fusion2_flow = nn.Conv2d(128, 64, kernel_size=1)
#         self.fusion2_edge = nn.Conv2d(128, 64, kernel_size=1)       
#         self.fusion3_flow = nn.Conv2d(192, 96, kernel_size=1)
#         self.fusion3_edge = nn.Conv2d(192, 96, kernel_size=1)   
#         self.fusion4_flow = nn.Conv2d(256, 128, kernel_size=1)
#         self.fusion4_edge = nn.Conv2d(256, 128, kernel_size=1)  
#         self.fusion5_flow = nn.Conv2d(256, 256, kernel_size=1)
#         self.fusion5_edge = nn.Conv2d(256, 256, kernel_size=1)    
...
#         flow_feature_1 = self.relu1(self.norm1(self.flow_layer1(x)))
#         x = (x + 1.) / 2. * 255.
#         edge_feature_1 = self.relu2(self.norm2(self.edge_layer1(x)))
#         fusion_feature_1 = torch.cat((flow_feature_1, edge_feature_1), dim=1)
#         flow_feature_1 = self.fusion1_flow(fusion_feature_1)
#         edge_feature_1 = self.fusion1_edge(fusion_feature_1)

#         # layer2
#         flow_feature_2 = self.flow_layer2(flow_feature_1)
#         edge_feature_2 = self.edge_layer2(edge_feature_1)
#         fusion_feature_2 = torch.cat((flow_feature_2, edge_feature_2), dim=1)
#         flow_feature_2 = self.fusion2_flow(fusion_feature_2)
#         edge_feature_2 = self.fusion2_edge(fusion_feature_2)

#         # layer3
#         flow_feature_3 = self.flow_layer3(flow_feature_2)
#         edge_feature_3 = self.edge_layer3(edge_feature_2)
#         fusion_feature_3 = torch.cat((flow_feature_3, edge_feature_3), dim=1)
#         flow_feature_3 = self.fusion3_flow(fusion_feature_3)
#         edge_feature_3 = self.fusion3_edge(fusion_feature_3)       

#         # layer4
#         flow_feature_4 = self.flow_layer4(flow_feature_3)
#         edge_feature_4 = self.edge_layer4(edge_feature_3)
#         fusion_feature_4 = torch.cat((flow_feature_4, edge_feature_4), dim=1)
#         flow_feature_4 = self.fusion4_flow(fusion_feature_4)
#         edge_feature_4 = self.fusion4_edge(fusion_feature_4)   

#         # layer5
#         flow_feature_5 = self.flow_layer5(flow_feature_4)
#         edge_feature_5 = self.edge_layer5(edge_feature_4)
#         fusion_feature_5 = torch.cat((flow_feature_4, edge_feature_4), dim=1)
#         flow_feature_5 = self.fusion5_flow(fusion_feature_5)
#         edge_feature_5 = self.fusion5_edge(fusion_feature_5)  
