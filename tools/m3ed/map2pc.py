...
if __name__ == '__main__':
    ...
    ap.add_argument("--dataset", 
                    ...
                    type=str)
    ap.add_argument("--platform", type=str, default="Falcon")
    ap.add_argument("--sequence",
                    default="falcon_outdoor_day_fast_flight_1",
    ...
    data_path = os.path.join(args.dataset, "original", args.platform, args.sequence, args.sequence+"_data.h5")
    ...
    for idx in tqdm.tqdm(range(Ln_T_L0.shape[0]-1)):
        ...
        # falcon_outdoor_day_penno_parking, falcon_outdoor_night_penno_parking, spot_outdoor_day_srt_under_bridge
